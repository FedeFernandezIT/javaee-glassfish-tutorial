 ...
 * @created 22 de mayo de 2017 19:43:47 ART
 */
@Entity
...
@NamedQueries({
    ...
    @NamedQuery(name = "findAllVendorParts",
                query = "SELECT vp FROM VendorPart vp " +
                        "ORDER BY vp.vendorPartNumber")
})
public class VendorPart implements Serializable {
    private static final long serialVersionUID = 4037325744074465250L;
