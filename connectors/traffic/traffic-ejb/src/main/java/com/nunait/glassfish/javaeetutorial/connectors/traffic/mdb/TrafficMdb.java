...
package com.nunait.glassfish.javaeetutorial.connectors.traffic.mdb;
 ...
 * @created 14 de junio de 2017 23:23:52 ART
 */
...
public class TrafficMdb implements TrafficListener {
    ...
    public void sendJMSUpdate(Map<String, String> update) {
        ...
        jmsContext.createProducer().send(topic, sw.toString());
        log.log(Level.INFO, "[TrafficMdb] {0}", sw.toString());
    }
}
